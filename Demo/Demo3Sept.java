...
/*           // définir notre objet scanner
        ...
        System.out.printf("Mon chat se nomme %s et ma chatte se nommme %s alors que mon chien se nomme %s et il a %d an(s).", nom, "Cocotte", "Grogon", age);
